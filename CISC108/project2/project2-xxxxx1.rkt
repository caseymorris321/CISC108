...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname project2-xxxxx1) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;;Project 2a: Snake
; Name: Casey Morris
; Name: Muhan Yu
(require 2htdp/image)
...
(define SNAKE-IMAGE (square 15 "solid" "red"))
(define FOOD-IMAGE (star 15 "solid" "green"))
(define STEP 1)
;****************-SNAKE-*****************
(define-struct snake [direction LOS alive?])
#|
...
interpretation:
 String direction : the direction the snake is facing which is one of
  ...
  "right"
Structure LOS 
Boolean alive? : #true if the snake is alive and #false if not
Constructor:
...
(define SNAKE0 (make-snake "right" #true (random 600) (random 800) SNAKE-IMAGE))
...
|#
(define FOOD0 (make-food #true FOOD-IMAGE "normal" 1 (random 600) (random 800)))
;**********************-SNAKEWORLD-****************************
...
interpretation:
 List snake-list : The list of snakes
 List food-list : The list offood
 Number score : current points of the world
Constructor:
 make-snakeworld : List List -> SnakeWorld
Selectors:
 snakeworld-snake-list : SnakeWorld -> List
 snakeworld-snake-list : SnakeWorld -> List
 snakeworld-score : SnakeWorld -> Number
Type:
 Any -> Boolean
Template for function consuming a SnakeWorld
(define (snakeworld-fun state)
 ... (snakeworld-snake-list state) ...
 ... (snakeworld-food-list state) ...
 ... (snakeworld-score state) ...)
|#
