...
(define (snake-fun a-snake)
 ...
 ... (snake-alive? a-snake) ...)
|#
(define SNAKE1 (make-snake (random 1000) (random 800) "left" SNAKE-HEAD #true))
(define SNAKE2 (make-snake (random 1000) (random 800) "left" SNAKE-BODY #true))
...
|#
(define SNAKEWORLD1 (make-snake-world (list SNAKE1) (list FOOD1 FOOD2) 0)) 
...
|#
(define LOS1 empty)
(define LOS2 (cons SNAKE1 LOS1))
(define LOS3 (cons SNAKE2 LOS2))
...
|#
(define LOF1 empty)
(define LOF2 (cons FOOD1 LOF1))
(define LOF3 (cons FOOD2 LOF2))
...
(check-expect (render-world SNAKEWORLD1) (render-snakes(snake-world-list-of-snakes SNAKEWORLD1)
                                                         (render-food(snake-world-list-of-food SNAKEWORLD1)
                                                                     BACKGROUND)))
(define (render-world state)
  (render-snakes(snake-world-list-of-snakes state)
                (render-food(snake-world-list-of-food state) 
                            BACKGROUND)))
